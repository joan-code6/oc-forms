...
export const textQuestions: TextQuestion[] = [
  ...
  },
  {
    id: "t8",
    type: "longtext",
    text: "Would you rather lead a nation or support one? Why?",
    order: 8,
    maxLength: 500,
    placeholder: "Explain whether you'd prefer to lead or support and why...",
  },
  {
    id: "t9",
    type: "longtext",
    text: "Would you rather be feared or trusted by other nations and why?",
    order: 9,
    maxLength: 500,
    placeholder: "Explain your preference and the reasoning behind it...",
  },
  {
    id: "t10",
    type: "longtext",
